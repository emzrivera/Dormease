...
import { TYPOGRAPHY, getResponsiveClass } from '../../../utils/responsive';
        ...
        <main>
          <section className="min-h-screen flex justify-center pt-5 sm:pt-10">
            <ResponsiveContainer maxWidth="sm">
              <div className="border border-t-8 rounded-lg border-dark w-full max-w-xs sm:max-w-sm mx-auto py-10 px-10 relative overflow-hidden">
                {/* Background Images */}
                  ...
                  <form className="mt-8 space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="email"
                        required
                        className="w-full px-4 py-1 border border-fieldBorder rounded-md focus:ring-1 focus:ring-light focus:border-light transition-colors"
                      />
                    </div>
                    ...
                    <button
                      type="button"
                      className="w-full border-2 border-dark text-dark hover:bg-dark hover:text-white font-figtree font-semibold px-4 py-1 rounded-md transition-colors focus:ring-2 focus:ring-light focus:ring-offset-2 flex items-center justify-center space-x-3"
                    >
                      <img 
                        src="/google-logo.svg" 
                        alt="Google Logo" 
